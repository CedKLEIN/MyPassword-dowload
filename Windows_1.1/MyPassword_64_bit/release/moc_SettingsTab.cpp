...
#include <memory>
#include "../../../MyPassword/Src/SettingsTab.h"
...
QT_MOC_LITERAL(4, 34, 22), // "securityIconShowChange"
QT_MOC_LITERAL(5, 57, 24) // "setSecurityThemeSettings"

    },
    "SettingsTab\0reset\0\0languageChange\0"
    "securityIconShowChange\0setSecurityThemeSettings"
};
...
void SettingsTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->languageChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->securityIconShowChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->setSecurityThemeSettings((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
